...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Achievement.can_nominate'
        db.add_column('achievements_achievement', 'can_nominate',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
        # sqlite specific hack to get the default values to actually be true
        if not db.dry_run:
            orm.Achievement.objects.update(can_nominate=True)

    def backwards(self, orm):
        # Deleting field 'Achievement.can_nominate'
        db.delete_column('achievements_achievement', 'can_nominate')
